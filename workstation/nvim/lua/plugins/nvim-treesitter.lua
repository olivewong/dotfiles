  ...
  },
  {
    ...
    opts = function(_, opts)
      ...
      local rust_check = {
        ...
        -- generator = helpers.generator_factory({
        --   command = "~/av/tools/rust_check.sh", -- Your script path
        --   args = {}, -- No extra arguments for your script
        --   to_stdin = false, -- This runs the command directly
        --   from_stderr = false,
        --   format = "json", -- The output from rust_check.sh is JSON
        --   check_exit_code = function(code)
        --     return code == 0 or code == 1 -- Successful exit codes
        --   end,
        --   -- Use helpers to parse the diagnostics from JSON
        --   on_output = helpers.diagnostics.from_json({
        --     -- Specify how to map your JSON fields to LSP diagnostics
        --     attributes = {
        --       row = "line_start",
        --       col = "column_start",
        --       end_row = "line_end",
        --       end_col = "column_end",
        --       severity = function(entry)
